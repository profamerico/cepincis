...
$mobileFooterLinks = [
    ...
    ['href' => './implement.php', 'label' => 'Áreas', 'icon' => 'fa-diagram-project', 'active' => $footerCurrentScript === 'implement.php'],
...
?>
    ...
    <nav class="mobile-page-footer" aria-label="Navegacao rápida">
        <?php foreach ($mobileFooterLinks as $mobileFooterLink): ?>
            <a
                href="<?php echo htmlspecialchars((string) $mobileFooterLink['href'], ENT_QUOTES | ENT_SUBSTITUTE, 'UTF-8'); ?>"
            ...
            >
                <i class="fa-solid <?php echo htmlspecialchars((string) $mobileFooterLink['icon'], ENT_QUOTES | ENT_SUBSTITUTE, 'UTF-8'); ?>"></i>
                <span><?php echo htmlspecialchars((string) $mobileFooterLink['label'], ENT_QUOTES | ENT_SUBSTITUTE, 'UTF-8'); ?></span>
            </a>
        <?php endforeach; ?>
    </nav>
