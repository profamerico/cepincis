                ...
                if ($result['success']) {
                    ...
                    if (!empty($result['created'])) {
                        $workspaceManager->notifyAdministrators(
                            ...
                            'project_created',
                            'Novo projeto criado',
                            'O projeto "' . (string) ($savedProject['title'] ?? 'Projeto') . '" foi criado e já está disponível no workspace.',
                            (string) ($savedProject['id'] ?? ''),
                            'project-workspace.php?id=' . rawurlencode((string) ($savedProject['id'] ?? '')),
                    ...
                    admin_set_flash(
                        'sucesso',
                        $result['created'] ? 'Projeto criado com sucesso. A documentação, quando necessária, pode ser enviada pelo workspace.' : 'Projeto atualizado com sucesso.'
                    );
